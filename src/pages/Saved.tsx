...
import { Search, User, Briefcase, MapPin, Trash2 } from "lucide-react";
...
const Saved = () => {
  // States
  const [showJobTemplateForm, setShowJobTemplateForm] = useState(false);
  ...
  const handleUseTemplate = (templateId: string) => {
    ...
    setShowJobTemplateForm(true);
    toast({
      title: "Template loaded",
      description: "Job template has been loaded for editing"
    });
  };
    ...
    <DashboardLayout>
      ...
      {showJobTemplateForm ? (
        <EnhancedJobPostingForm 
          onCancel={() => setShowJobTemplateForm(false)}
          onSuccess={() => {
            setShowJobTemplateForm(false);
            toast({
              title: "Success!",
              description: selectedTemplateId ? "Job posted successfully from template." : "Job template created successfully."
            });
          }}
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-4 flex justify-between items-center">
                              ...
                              <div className="flex gap-2">
                                <Button size="sm" onClick={() => handleUseTemplate(job.id)}>Use Template</Button>
                                <Button size="sm" variant="outline" className="text-red-500 hover:text-red-700">
                                  <Trash2 className="h-4 w-4" />
                                </Button>
                              </div>
